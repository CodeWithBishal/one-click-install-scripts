...
mysql -sfu root "-p$DATABASE_USER_PASSWORD" -e \
...
git clone "$GIT_CLONE_LINK" "/var/www/$NAME" 
...
certbot certonly --non-interactive --agree-tos -m $ADMIN_EMAIL -d $DOMAIN -d www.$DOMAIN --webroot -w /var/www/$NAME/
